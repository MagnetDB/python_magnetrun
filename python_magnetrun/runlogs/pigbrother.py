#!/usr/bin/env python3
"""
pigbrother — Log parser for the LabVIEW/DAQmx acquisition system.

This module was formerly ``python_magnetrun.tdms.log_parser``.

Log file: ``LOG_ACQ_ENET.txt`` — a single file co-located with the pigbrother
``.tdms`` data files (e.g. ``/mnt/LNCMIG-Data/records/pbsurv/LOG_ACQ_ENET.txt``).
...
PIGBROTHER_LOG_FILENAME = "LOG_ACQ_ENET.txt"
