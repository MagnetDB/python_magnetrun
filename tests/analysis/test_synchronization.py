...
from python_magnetrun.analysis.config import LAG_THRESHOLD_RATIO
...
class TestApplyLagCorrection:
    ...
    def test_with_reference_t0(self):
        ...
        df_corrected = apply_lag_correction(
            df, 2.0,
...
class TestCheckLagReliability:
    ...
    def test_unreliable_lag(self):
        ...
        assert not check_lag_reliability(
            lags=(50.0, 50.0),
            duration=100.0,
            threshold_ratio=0.2
        )
