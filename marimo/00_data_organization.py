...
def _(mo):
    ...
    | **PigBrother** (power installation) | `.tdms` | 1 Hz (Overview), 420 Hz (Archive), 4800 Hz (Defaults) | `TdmsMagnetData` |
...
def _(mo):
    ...
    * **kHz** — `HOST_1_LIST_0.bin`, `HOST_1_LIST_1.bin`, … (one per recording channel) + calibration files (`CLN_1.CNV`, …) + metadata (`HOST_1_DATA.CFG`).
